 ...
 */
public enum State {
    NO_INSPECTION_HAS_BEGUN, AN_INSPECTION_HAS_STARTED, DOOR_HAS_CLOSED, 
    ...
    THERE_ARE_MORE_INSPECTIONS_TO_BE_MADE, THERE_ARE_NO_MORE_INSPECTIONS, 
    INSPECTOR_GOT_ANOTHER_INSPECTION, INSPECTOR_ENTERED_A_REMARK, 
